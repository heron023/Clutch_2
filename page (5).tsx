...
:root {
  ...
  --card: oklch(0.185 0.013 260);
  --card-foreground: oklch(0.97 0.005 250);
  --popover: oklch(0.185 0.013 260);
  ...
  --muted-foreground: oklch(0.66 0.015 255);
  --accent: oklch(0.26 0.015 260);
  --accent-foreground: oklch(0.97 0.005 250);
  --destructive: oklch(0.62 0.22 20);
  --destructive-foreground: oklch(0.97 0.005 250);
  --border: oklch(0.28 0.013 260);
  --input: oklch(0.26 0.013 260);
  --ring: oklch(0.7 0.16 250);
  --chart-1: oklch(0.7 0.16 250);
  --chart-2: oklch(0.76 0.17 155);
  --chart-3: oklch(0.8 0.15 80);
  --chart-4: oklch(0.65 0.2 295);
  --chart-5: oklch(0.68 0.21 18);
  --radius: 0.875rem;
  --sidebar: oklch(0.165 0.013 260);
  ...
  --sidebar-border: oklch(0.27 0.013 260);
...
@utility grid-bg {
  background-image: linear-gradient(to right, oklch(0.97 0.005 250 / 0.03) 1px, transparent 1px),
    linear-gradient(to bottom, oklch(0.97 0.005 250 / 0.03) 1px, transparent 1px);
